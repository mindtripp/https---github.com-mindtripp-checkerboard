...
@app.route('/')
def index():
    return render_template("index.html",row=8,col=8,color_one='blue',color_two='black')
...
def row_col(x,y):
    return render_template("index.html",row=x,col=y,color_one='blue',color_two='black')
